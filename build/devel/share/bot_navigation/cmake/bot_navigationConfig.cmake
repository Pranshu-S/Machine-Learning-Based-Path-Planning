...
if("TRUE" STREQUAL "TRUE")
  set(bot_navigation_SOURCE_PREFIX /home/ros/IEEE/src/bot_navigation)
  set(bot_navigation_DEVEL_PREFIX /home/ros/IEEE/src/build/devel)
  ...
  set(bot_navigation_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'bot_navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'bot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/IEEE/src/bot_navigation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT bot_navigation_NUM_DUMMY_TARGETS)
      set(bot_navigation_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::bot_navigation::wrapped-linker-option${bot_navigation_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR bot_navigation_NUM_DUMMY_TARGETS "${bot_navigation_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::bot_navigation::wrapped-linker-option${bot_navigation_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND bot_navigation_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${bot_navigation_dep}_FOUND)
      find_package(${bot_navigation_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${bot_navigation_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
